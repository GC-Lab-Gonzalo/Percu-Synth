...
| Archivo                            | Qué es                                                                 |
|------------------------------------|------------------------------------------------------------------------|
| `paisajes_relax_leds_esp32s3.bin`  | Imagen **merged** (bootloader + particiones + boot_app0 + app), ~540 KB |
...
- **Desde el navegador (PC, Chrome/Edge):** copia `paisajes_relax_leds_esp32s3.bin` a
...
- **Desde la terminal:** `esptool --chip esp32s3 write-flash 0x0 paisajes_relax_leds_esp32s3.bin`
