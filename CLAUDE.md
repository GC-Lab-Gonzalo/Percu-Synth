...
**No sketch may carry a WiFi password or an API key in its `.ino`.** The five AI firmwares
(`asistente_ia`, `asistente_musical`, `sampler_ia`, `oscilador_ia`, `compositor_ia`) each ship a
