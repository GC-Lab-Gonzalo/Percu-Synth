...
│   ├── cancion_aleatoria_leds/     #   Autonomous random-song machine (Play/Stop + volume only): generative key/mode/progression/tempo + random monophonic melody + 6 LEDs
